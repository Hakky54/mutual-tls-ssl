[![Actions Status](https://github.com/hakky54/mutual-tls-ssl/actions/workflows/maven.yml/badge.svg)](https://github.com/Hakky54/mutual-tls-ssl/actions)
...
[![JDK compatibility: 21](https://img.shields.io/badge/JDK_compatibility-21-blue.svg)](#)
...
Hey, hello there 👋 welcome to this tutorial! I hope you will like it.

This tutorial came to life when I initially wanted to learn mutual authentication based on TLS. So it was not a tutorial at all, but just a pet project. 
I wanted to learn how to set it up locally and what commands I need to use. As I got it working I assumed it might be useful for others, so I have refactored to make it easily repeatable and have it as a tutorial at this page so others can learn from it.

I have created this tutorial with ❤️ and passion, mostly during evening and night hours. If you use my tutorial and want to appreciate the work I have done, please consider to sponsor this project as a way to contribute back to the community.
...
* [Curl with Java KeyStore](https://gist.github.com/Hakky54/049299f0874fd4b870257c6458e0dcbd)
...
**Clojure**
* [clj-http](https://github.com/dakrone/clj-http) -> [Client Configuration & Example request](https://github.com/Hakky54/mutual-tls-ssl/blob/master/client/src/main/java/nl/altindag/client/service/CljHttpClientService.clj)
...
* [Hato](https://github.com/gnarroway/hato) -> [Client Configuration & Example request](https://github.com/Hakky54/mutual-tls-ssl/blob/master/client/src/main/java/nl/altindag/client/service/HatoHttpClientService.clj)
* [Aleph](https://github.com/clj-commons/aleph) -> [Client Configuration & Example request](https://github.com/Hakky54/mutual-tls-ssl/blob/master/client/src/main/java/nl/altindag/client/service/AlephHttpClientService.clj)
* [Http-Kit](https://github.com/http-kit/http-kit) -> [Client Configuration & Example request](https://github.com/Hakky54/mutual-tls-ssl/blob/master/client/src/main/java/nl/altindag/client/service/HttpKitService.clj)
...
* [curl](https://curl.se/) -> [Client Configuration & Example request](https://gist.github.com/Hakky54/049299f0874fd4b870257c6458e0dcbd)
...
* Give it a star
* Make a donation through [GitHub](https://github.com/sponsors/Hakky54), [Ko-fi](https://ko-fi.com/hakky54) or [open collective](https://opencollective.com/hakky54)
