...
Below is a list of already tested clients, see in the [ClientConfig class](client/src/main/java/nl/altindag/client/ClientConfig.java) and [service directory](client/src/main/java/nl/altindag/client/service) for examples and detailed configuration
...
* [Ktor Http Client with Apache](https://ktor.io/clients/http-client/engines.html#apache)
* [Ktor Http Client with OkHttp](https://ktor.io/clients/http-client/engines.html#okhttp)
* [Ktor Http Client with Jetty](https://ktor.io/clients/http-client/engines.html#jetty)
* [Ktor Http Client with Coroutine-based I/O](https://ktor.io/clients/http-client/engines.html#cio)
