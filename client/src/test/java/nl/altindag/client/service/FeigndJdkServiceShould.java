...
class FeigndJdkServiceShould {
    ...
    void executeRequest() throws Exception {
        ...
        when(server.getHello(ClientType.FEIGN_JDK_HTTP_CLIENT.getValue())).thenReturn("Hello");
    ...
    @Test
    void getClientType() {
        assertThat(victim.getClientType()).isEqualTo(ClientType.FEIGN_JDK_HTTP_CLIENT);
    }
