...
class FeignApacheServiceShould {

    @InjectMocks
    private FeignApacheService victim;
    @Mock
    ...
    void executeRequest() throws Exception {
        ...
        when(server.getHello(ClientType.FEIGN_APACHE_HTTP_CLIENT.getValue())).thenReturn("Hello");
    ...
    @Test
    void getClientType() {
        assertThat(victim.getClientType()).isEqualTo(ClientType.FEIGN_APACHE_HTTP_CLIENT);
    }
