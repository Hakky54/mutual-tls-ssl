...
import static nl.altindag.client.TestConstants.SPRING_WEB_CLIENT_JETTY;
...
public class SpringWebClientJettyWrapperShould {
    ...
    public void executeRequest() throws Exception {
        ...
        when(requestHeadersUriSpec.header(HEADER_KEY_CLIENT_TYPE, SPRING_WEB_CLIENT_JETTY)).thenReturn(requestHeadersUriSpec);
