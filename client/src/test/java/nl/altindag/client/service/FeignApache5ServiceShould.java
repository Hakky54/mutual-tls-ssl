...
class FeignApache5ServiceShould {

    @InjectMocks
    private FeignApache5Service victim;
    @Mock
    ...
    void executeRequest() throws Exception {
        ...
        when(server.getHello(ClientType.FEIGN_APACHE5_HTTP_CLIENT.getValue())).thenReturn("Hello");
    ...
    @Test
    void getClientType() {
        assertThat(victim.getClientType()).isEqualTo(ClientType.FEIGN_APACHE5_HTTP_CLIENT);
    }
