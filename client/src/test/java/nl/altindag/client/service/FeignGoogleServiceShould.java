...
class FeignGoogleServiceShould {

    @InjectMocks
    private FeignGoogleService victim;
    @Mock
    ...
    void executeRequest() throws Exception {
        ...
        when(server.getHello(ClientType.FEIGN_GOOGLE_HTTP_CLIENT.getValue())).thenReturn("Hello");
    ...
    @Test
    void getClientType() {
        assertThat(victim.getClientType()).isEqualTo(ClientType.FEIGN_GOOGLE_HTTP_CLIENT);
    }
